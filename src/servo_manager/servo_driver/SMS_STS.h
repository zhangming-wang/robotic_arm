...
class SMS_STS : public SCSerial {
  public:
    ...
    virtual void SyncWritePosEx(u8 ID[], u8 IDN, s16 Position[], s16 Speed[], u8 ACC[]); // 同步写多个舵机位置指令
    virtual bool SyncReadPosEx(u8 ID[], u8 IDN, s16 Position[], s16 Speed[]);            // 同步读多个舵机位置指令
